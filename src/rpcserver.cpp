...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ALN features */
        {"alphanode", "masternode", &masternode, true, true, false},
        {"alphanode", "masternodelist", &masternodelist, true, true, false},
        {"alphanode", "mnbudget", &mnbudget, true, true, false},
        {"alphanode", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"alphanode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"alphanode", "mnsync", &mnsync, true, true, false},
        {"alphanode", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"alphanode", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use alphanoded, or the -server option to alphanode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> alphanode-cli " + methodname + " " + args + "\n";
}
