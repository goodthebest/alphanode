/* src/config/alphanode-config.h.  Generated from alphanode-config.h.in by configure.  */
/* src/config/alphanode-config.h.in.  Generated from configure.ac by autoheader.  */
