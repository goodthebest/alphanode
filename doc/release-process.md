...
### Build and sign ALN Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit alphanode=v${VERSION} ../alphanode/contrib/gitian-descriptors/gitian-win.yml
